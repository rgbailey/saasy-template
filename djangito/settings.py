...
PROJECT_APPS = ["usermodel", "ses_sns", "pages", "blog", "dashboard"]
...
if AWS_STORAGE_BUCKET_NAME:
    ...
    # look for static files in root, not just apps
...
ACCOUNT_EMAIL_VERIFICATION = "none"  # should i make this mandatory?
ACCOUNT_FORMS = {"signup": "usermodel.forms.MyCustomSignupForm"}
ACCOUNT_MAX_EMAIL_ADDRESSES = 2
SOCIALACCOUNT_PROVIDERS = {}
SOCIALACCOUNT_PROVIDERS_GOOGLE_CLIENT_ID = env(
    "SOCIALACCOUNT_PROVIDERS_GOOGLE_CLIENT_ID", default=None
)
